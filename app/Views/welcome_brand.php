<section class="hero text-center py-5 bg-sciclo bg-background">
    <div class="container py-5">
        <img src="/assets/logo/logo_sciclo.png" alt="Logo Sciclo" class="mb-4" style="max-width: 440px;">
        ...
        <a href="#portfolio" class="btn btn-light btn-lg px-4 me-2">Sobre a certificação</a>
